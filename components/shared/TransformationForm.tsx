...
function TransformationForm ({action, data = null,
    userId, type,creditBalance, config = null}: TransformationFormProps) {
  
  // finding the function chosen by the user eg. restore,remove,fill etc... 
    ...
    <Form {...form}>
      ...
      {creditBalance < Math.abs(creditFee) && <InsufficientCreditsModal />}
        ...
        <div className="flex flex-col gap-4">
          <Button 
            type="button"
            className="submit-button capitalize hover:translate-y-[5px] hover:translate-x-[5px]
                 hover:shadow-none transition-all duration-100 shadow-[5px_5px_0px_2px_#000000]"
